...
$chemin = "../images/albums_phototheque/";  // "/" à la fin
				...
				<form method="post" action="" enctype="multipart/form-data">
				    ...
				    <input type="hidden" name="page" value="<?=$lapage?>">
							...
							<div class="col-sm-12 col-md-6">
									...
									<h4><i class='fa fa-pencil-square-o '></i> Nom de l'album photo</h4>
							        <div class="form-group">
								        <input name="<?=$chps[1]?>" value="<?=$$chps[1]?>" class="form-control" type="text" required  />
							        </div>
							        
	      
									<h4><i class='fa fa-calendar '></i> Date d'enregistrement</h4>
							        <div class="form-group">
							...
							<div class="col-sm-12 col-md-6 ">
								...
								<div class="zone-photos"> 
										...
										<?php include "include/photos_sup.php";
