...
$ogtitre='Association nationale des greffés cardiaques et pulmonaires';
$ogdescr='Association nationale des greffés cardiaques et pulmonaires';
  ...
  {	$table = $table_prefix."_pages"; 
	...
	$keywords=motcle($titremeta).",".motcle($description);
  	$ogimg='http://'.$_SERVER['HTTP_HOST'].dirname($_SERVER["PHP_SELF"]).'/images/pages-don-d-organes-coeur-poumons-belgique/'.$IDmeta.'.jpg';
